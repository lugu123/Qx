...
# 50度灰
^https?:\/\/p4.yjnkrdji.org/pwa.php/api/(user/userinfo|MvDetail/(detail|xiao_detail)|home/(getOpenAdsAndVersion|appcenter)|system/getad) url script-response-body https://raw.githubusercontent.com/lugu123/Qx/main/lsp.js
# 微密圈
...
# 𝐀𝐋𝐋
^(https?:\/\/)(?!long)([^./]+\.)*(jsrkxh.cn)(\/.*)? url 302 $1long.$3$4
#加上抓包的视频地址如ecexzemzl.cc
******************************************/
